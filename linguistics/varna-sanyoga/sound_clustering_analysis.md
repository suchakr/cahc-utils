...
- अ (a) - Very high frequency (16.26%)
- प् (p) - 7.70%
- स् (s) - 6.65%
- व् (v) - 6.60%
- त् (t) - 6.00%

This cluster features kavyas with high usage of the basic vowel अ (a) and moderate usage of consonants like प् (p) and स् (s). These works likely have a more flowing, open sound quality with many open syllables.
...
Works in this cluster feature higher usage of hard consonants like प् (p) and क् (k), giving them a more staccato, rhythmic quality.

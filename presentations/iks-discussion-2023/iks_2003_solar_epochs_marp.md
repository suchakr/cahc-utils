...
# Solar Transits in <br> pre-Common-Era Texts <br>&<br>  their Dating using <br> the precession phenomenon
...
|--:|---|---|---|:---|
|1| varṣā start | **dakṣiṇāyana start** | summer solstice | ![](swing-01-ss.png) <br>sun rises north east
|62| śarad start| dakṣiṇāyana | - | -
|92 |śarad mid | **viṣuvat** | autumn equinox | ![](swing-02-ae.png)  <br> sun rises true east
|123 | hemanta start  | dakṣiṇāyana | - |
|183<br>184 | śiśira start  | **dakṣiṇāyana end**<br> **uttarāyaṇa start**| winter solstice | ![](swing-03-ws.png) <br> sun rises south east
|245 | vasanta start | uttarāyaṇa | - | -
|274 | vasanta mid | **viṣuvat** | spring equinox |  ![](swing-04-se.png) <br> sun rises true east
|306 | grīṣma start | uttarāyaṇa | - | -
|366 | grīṣma-end | **uttarāyaṇa end**<br>**dakṣiṇāyana start**  | summer solstice | ![](swing-01-ss.png)  <br> sun rises north east
...
|||
|:---:|:--:|
|Present Day <br> ![bgbg](prec-01-2000-ce.png) | 5000 years ago <br> ![](prec-06-3000-bce.png)|
...
## The Maghādi/dakṣināyaṇa epoch - Maitrāyaṇīya Āraṇyaka Upaniṣat and Brahmāṇḍa Purāṇa
...
The NS passage indicates that the 
...
This BP passage defines visuvat to be of equal day and night duration of 15 muhūrtas each - equinox - in the mis of vasant and śarad ṛtus.
...
2. Per **MAU** - The *sun is at Maghādi at start of dakṣiṇāyana*. Further Mahāsaliaṃ chapter of Vṛddagārgīya Jyotiṣa (VGJ) states Maghā to be the first among the solar nakṣatras. 
...
## Computing the information of  MAU, NS and BP
...
<!-- This mapping helps date the observation by searching for an epoch .
...
## Dating -  Best fit by minimizing error metric
<style scoped>
    table { margin-left: -25px; font-size: 15px; }
    table td:nth-child(2) { width: 10px; }
    table td:nth-child(3) { width: 10px; }
...
<style scoped>
    ...
    table th:nth-child(3) { display: none; }
    table td:nth-child(5) { display: none; }
    img { filter: invert(5%); height: 520px;  position: absolute; transform: translate(58%, -5%); z-index: -1;  border: 0px solid black; }

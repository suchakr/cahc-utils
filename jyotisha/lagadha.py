...
त्रिभिर्विहीनं कुडवैस्तु कार्यं तन्नाडिकायास्तु भवेत् प्रमाणम्॥ य २४॥ 
...
syms = symbols(
  'पलम् आढकः द्रोण_कुम्भकः कुडव_कुटपः नाडिका' +
  ' मुहुर्तम् कला काष्ठा'+
  ' युगः पर्वः चान्द्रायनम् भागा अंश_भांशम् नक्षत्रम्' + 
  ' गुर्वाक्षरः सौरर्तुः सौरायनम्  अब्दः' +
...
for sym in syms :
  ...
  # त्रिभिर्विहीनं कुडवैस्तु कार्यं तन्नाडिकायास्तु भवेत् प्रमाणम्॥ य २४॥ 
    आढकः - पलम्/50,   
    द्रोण_कुम्भकः - आढकः/4 ,    
    नाडिका - द्रोण_कुम्भकः-3*कुडव_कुटपः, # ऋ २४, य १७
    आढकः - कुडव_कुटपः/16,    # ऋ २४ 

  # नाडिके द्वे मुहुर्तस्तु पंचाशत्पलमाढकम्। 
  # आढकात्कुम्भको द्रोणः कुटपैर्वर्धते त्रिभिः॥ऋ १७॥
    मुहुर्तम्  - नाडिका/2,  # ऋ १७
    # कुम्भक - द्रोण,    # ऋ १७
    # कुटप - कुडव,    # ऋ १७
  ...
  # द्युस्त्रिंशंत् तत्कलानां तु षट्शती त्र्यधिका भवेत्॥ ऋ १६ ,य ३८॥
    ...
    नाडिका - 2*मुहुर्तम् ,  # य १७ ऋ १६ ,य ३८
    द्युः - कला/603, #  ऋ १६ ,य ३८
    द्युः - मुहुर्तम् /30,  #  ऋ १६ ,य ३८

  # पंचत्रिंशं शतं पौष्णम् एकोनमयनोन्यृषेः। 
  # पर्वणां स्याच्चतुष्पादी काष्ठानां चैव ताः कलाः॥य ३०॥
    युगः - चान्द्रायनम् /134, #(135-1) , # य ३०
    युगः - पर्वः/124, #(4*31) , # य ३०
  ...
  # print(solved, str(sym))
  ans = pd.DataFrame( solved, index=[str(sym)], dtype='float').T
  # display(ans.T)
  dfs.append((sym, ans))
...
display(clip_top(df1), clip_top(df2))
...
#%%
# convert df to html
# df.to_html("../datasets/vj-units-ratio.html")

# style the dataframe
# df1.style.set_properties(**{'text-align': 'right'})
# df1.style.set_table_styles([{'selector': 'th', 'props': [('text-align', 'right')]}])
# df1.style.set_table_styles([{'selector': 'tr:nth-child(odd)', 'props': [('background-color', '#eee')]}])
# df1.style.set_table_styles([{'selector': 'tr:nth-child(even)', 'props': [('background-color', 'red')]}])
df1.to_html("../datasets/vj-units-ratios~.html")

...
TSV_PATH = BASE_DIR / "scraped" / "ijhs-classified.tsv"
OUTPUT_JS_PATH = BASE_DIR / "ijhs-darpan" / "assets" / "js" / "data.js"
SYMLINK_DIR = BASE_DIR / "ijhs-darpan" / "assets" / "pdfs"

# Source directories for PDFs (where we look for files)
# Assets are in a sibling repo `cahcblr.github.io`
ASSETS_ROOT = BASE_DIR.parent.parent.parent / "cahcblr.github.io" / "assets"
